		...
		<div class="main">
			<div class="main_1">
				<div class="main_1_box">
					<div class="main_txt">
						<div
							class="main_txt_up animate__animated animate__lightSpeedInRight"
						>
							놀러오세요! 경상도, 좋아요!<br />
						</div>
						<div class="main_txt_down">
							블루베리스무디 맛있어요.<br />이의이승이 뭐냐구요?<br />일단,
							와보면 알아요!
						</div>
					</div>
					<!-- 날씨는 반응형 태블릿 때 사라짐 -->
					...
					<div class="main_box_right">
						<div class="main_2_news">
							<div class="main_2_news_l">
								...
								<div class="art_tit">
									포항 구룡포 선착장에서 열리는 국내 최초의 부두 야시장
								</div>
								<div class="art_con">
									해녀조합과 함께하는 해녀 마켓, 전국 최고의 푸드트럭 만...
								</div>
							...
							<div class="main_2_news_l">
								...
								<div class="art_tit">
									합천 씨파크에서 남녀노소 전 연령대가 다양한 문화를 즐길 수
									있는 겨울 축제
								</div>
								<div class="art_con">
									실내 난방을 포함, 몸만와서 즐길 수 있는 캠프닉 공간 이...
								</div>
							...
							<li>
								<a href="#" target="여행">
									...
									<div class="main_hot3_txt">
										...
										>
										<p>
											전용시설에서 반려동물과<br />사계절 뛰어놀 수 있는 특별한
											곳
										</p>
									</div>
								</a>
				...
				<div class="main_4_box">
					...
					<div class="main_box_right">
						<div class="main_4_menu">
							<a href="#"
								>자유<br />게시판<font-awesome-icon :icon="['fas', 'comments']"
							/></a>
							<a href="#"
								>질문<br />게시판<font-awesome-icon :icon="['fas', 'leaf']"
							/></a>
							<a href="#"
								>정보<br />게시판<font-awesome-icon :icon="['fas', 'file-pen']"
							/></a>
							<a href="#"
								>건의<br />게시판<font-awesome-icon
